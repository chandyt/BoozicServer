...
namespace Boozic.Repositories
{
    public interface IProductsRepository : IObjectRepository<Product>
    {
        ...
        String UpdateProduct(int ProductId, int StoreId = -1, double Price = -1, string ProductName = "-1", int ProductTypeId = -1, double ABV = -1, double Volume = -1, 
                            string VolumeUnit = "-1", string ContainerType = "-1", int ContainerQty = -1, string DeviceId = "-1", int Rating = -1,  int AddToFavouritesList = -1);
